    ...
    detailsServices: {
      cleaningPestControl: [
        ...
        },
        {
          ...
          text: `El servicio se realiza en varias fases:`,
          description: `Servicio especializado para eliminar grasa incrustada, bacterias y suciedad acumulada en cocinas domésticas o profesionales. Ideal para hogares, restaurantes y negocios de hostelería.`,
          phases: [
            { step: `1 - Evaluación inicial .` },
            { step: `2 - Preparación y protección del área.` },
            { step: `3 - Desengrase intensivo.` },
            { step: `4 - Limpieza de electrodomésticos.` },
            { step: `5 - Tratamiento de superficies.` },
            { step: `6 - Limpieza de zonas críticas.` },
            { step: `7 - Desinfección final.` },
          ],
          key: Math.random(),
        },
        {
          ...
          text: `El servicio se realiza en varias fases:`,
          description: `Servicio integral de limpieza profesional para todas las estancias de una vivienda, incluyendo dormitorios, baños, cocina, salón y zonas comunes.`,
          phases: [
            { step: `1 - Evaluación inicial.` },
            { step: `2 - Limpieza aérea y desempolvado.` },
            { step: `3 - Limpieza profunda de cocina.` },
            { step: `4 - Limpieza higiénica de baños.` },
            { step: `5 - Limpieza de estancias habitables.` },
            { step: `6 - Limpieza finales de suelos.` },
            { step: `7 - Control de calidad.` },
          ],
          key: Math.random(),
        },
        {
          ...
          description: `Este servicio ofrece una limpieza completa y profesional de todas las superficies de un espacio, ya sea una vivienda, oficina, local comercial u otros. El objetivo es eliminar la suciedad acumulada y devolver un aspecto impecable a cada rincón.`,
          phases: [
            { step: `1 - Evaluación inicial.` },
            { step: `2 - Preparación y protección del área.` },
            { step: `3 - Desempolvado general.` },
        ...
        },
        {
          ...
          description: `Este servicio ofrece una limpieza completa y profesional de todas las superficies de un espacio, ya sea una vivienda, oficina, local comercial u otros. El objetivo es eliminar la suciedad acumulada y devolver un aspecto impecable a cada rincón.`,
          phases: [
            { step: `1 - Evaluación inicial.`, key: Math.random() },
            { step: `2 - Preparación y protección del área.`, key: Math.random() },
            { step: `3 - Desempolvado general.`, key: Math.random() },
            { step: `4 - Limpieza de paredes y techos.`, key: Math.random() },
            { step: `5 - Limpieza de suelos.`, key: Math.random() },
            { step: `6 - Limpieza de ventanas y cristales.`, key: Math.random() },
            { step: `7 - Toques finales y revisión.`, key: Math.random() },
          ],
          key: Math.random(),
        },
        {
