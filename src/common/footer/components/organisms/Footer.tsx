import CompanyInformation from '@/common/footer/components/molecules/CompanyInformation'
import OtherLinks from '@/common/footer/components/molecules/OtherLinks'
import OurTeam from '@/common/footer/components/molecules/OurTeam'
import SocialNetworks from '@/common/footer/components/molecules/SocialNetworks'
import AllowedCards from '@/common/footer/components/molecules/AllowedCards'
import SecondaryDescription from '@/common/footer/components/molecules/SecondaryDescription'
import ContactUs from '@/common/footer/components/molecules/ContactUs'
import TermsConditions from '@/common/footer/components/molecules/TermsConditions'
