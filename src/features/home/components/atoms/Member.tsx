    ...
    <div className={clsx(`horizontal relative col-span-6`)}>
      <Image
        ...
        className={clsx(
          ...
          `${index == 0 ? '3xl:min-h-44 3xl:w-[13.4375rem] 4xl:w-64 4xl:min-h-52 2xl:min-h-32 2xl:w-[10.4375rem]' : ''}`,
          // --
          `${index == 1 ? 'border-warning shadow-small absolute top-0 h-[4.6875rem] w-[4.6875rem] rounded-full border-3' : ''}`,
          `${index == 1 ? '3xl:w-32 3xl:h-32 4xl:h-[9.75rem] 4xl:w-[9.75rem] 4xl:top-1 4xl:left-1 2xl:h-[5.625rem] 2xl:w-[5.625rem]' : ''}`,
          // --
          `${index == 2 ? 'border-warning shadow-small absolute -top-1 right-10 h-[4.6875rem] w-[4.6875rem] rounded-full border-3' : ''}`,
          `${index == 2 ? '3xl:w-32 3xl:h-32 3xl:-top-0.5 4xl:h-[9.75rem] 4xl:w-[9.75rem] 3xl:right-[2.6875rem] 4xl:right-12 2xl:h-[5.625rem] 2xl:w-[5.625rem]' : ''}`,
          // --
          `${index == 3 ? 'border-default-50 shadow-medium rounded-medium absolute -top-10 -left-10 z-10 min-h-28 border-8' : ''}`,
          `${index == 3 ? '3xl:min-h-44 3xl:w-[13.4375rem] 3xl:-top-12 3xl:-left-11 4xl:w-64 4xl:min-h-52 2xl:min-h-32 2xl:w-[10.4375rem]' : ''}`
        )}
        src={imageUrl}
      />
    </div>
