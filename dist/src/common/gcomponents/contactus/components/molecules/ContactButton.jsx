...
export default function ContactButton(props) {
    ...
    return (<Button isExternal className={clsx(`horizontal h-auto w-auto min-w-[3.1875rem] justify-center px-0.5 py-1`)} as={Link} href={href} color={`success`} variant={`shadow`} radius={`lg`}>
      <Image className={clsx(`h-10 w-10`)} src={imageUrl} width={40} height={40} alt={`Image's contact`}/>
    </Button>);
}
