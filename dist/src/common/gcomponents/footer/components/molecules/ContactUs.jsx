...
export default function ContactUs(props) {
    ...
    return (<div className={clsx(`flex h-auto w-full flex-col justify-center gap-y-0.5`, `3xl:flex-row 3xl:justify-evenly 3xl:gap-y-0`)}>
      {contactUs.map((contact) => (<Contact key={contact.key} {...{ icon: contact.icon, href: contact.href, name: contact.name }}/>))}
    </div>);
}
