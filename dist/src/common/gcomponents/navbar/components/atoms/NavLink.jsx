...
export default function NavLink(props) {
    ...
    return (<NavbarItem className={clsx(`horizontal h-auto w-auto`)}>
      <Link aria-current={isActive ? 'page' : undefined} className={clsx(`text-default-900 text-large`)} href={href}>
        {text}
      </Link>
    </NavbarItem>);
}
