...
import { TicketIcon, BanknotesIcon, ClockIcon, GiftIcon, ShieldCheckIcon, ExclamationTriangleIcon, WrenchScrewdriverIcon, PercentBadgeIcon, } from '@heroicons/react/24/solid';
 ...
 */
export var BenefitIcon;
(function (BenefitIcon) {
    BenefitIcon["DISCOUNT"] = "discount";
    BenefitIcon["MONEY"] = "money";
    BenefitIcon["CLOCK"] = "clock";
    BenefitIcon["GIFT"] = "gift";
    BenefitIcon["SHIELD"] = "shield";
    BenefitIcon["BADGE"] = "badge";
    BenefitIcon["ALERT"] = "alert";
    BenefitIcon["WORK"] = "work";
...
const iconSwitch = (icon) => {
    switch (icon) {
        case BenefitIcon.DISCOUNT:
            return (<TicketIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
        case BenefitIcon.MONEY:
            return (<BanknotesIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
        case BenefitIcon.CLOCK:
            return (<ClockIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
        case BenefitIcon.GIFT:
            return (<GiftIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
        case BenefitIcon.SHIELD:
            return (<ShieldCheckIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
        case BenefitIcon.BADGE:
            return (<PercentBadgeIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
        case BenefitIcon.ALERT:
            return (<ExclamationTriangleIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
        case BenefitIcon.WORK:
            return (<WrenchScrewdriverIcon className={clsx(`fill-content2 h-[1.4375rem] w-[1.4375rem]`, `3xl:h-[1.6875rem] 3xl:w-[1.6875rem] 2xl:h-6 2xl:w-6`)}/>);
    }
};
/**
...
export default function Benefit(props) {
    ...
    return (<Card className={clsx(`bg-content2 border-content3 h-[18.9375rem] w-80 border-1 px-3 py-3.5`, `2xl:h-[19.5rem] 2xl:w-[20.9375rem]`)} shadow={`sm`}>
      <CardHeader className={clsx(`horizontal pt-2 pb-2.5`)}>
        <div className={clsx(`vertical h-auto w-full items-start gap-3.5`)}>
          <div className={clsx(`bg-warning hrizontal h-auto w-auto justify-center rounded-full p-1.5`, `border-warning shadow-small border-1`)}>
            <span className={clsx(`h-auto w-auto`)}>{iconSwitch(icon)}</span>
          </div>
          <h3 className={clsx(`text-default-900 text-left text-[1.1875rem] font-bold text-shadow-sm`, `2xl:text-xl`)} itemProp={title}>
            {title}
          </h3>
        </div>
      </CardHeader>
      ...
      <CardFooter className={clsx(`vertical items-start pt-3.5 pb-0 pl-2.5`)}>
        <Button isExternal className={clsx(`bg-content1 border-content4 mb-2.5 border-1 shadow-sm`, `2xl:min-h-8 2xl:py-4`)} as={Link} href={href} variant={`flat`} size={`sm`} radius={`full`} aria-label={hrefText}>
