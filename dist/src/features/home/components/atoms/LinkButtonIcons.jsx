 ...
 */
export var LinkButtonIconType;
(function (LinkButtonIconType) {
    LinkButtonIconType["LOCATION"] = "location";
    LinkButtonIconType["SERVICES"] = "services";
    LinkButtonIconType["SEARCH"] = "search";
    LinkButtonIconType["TEAM"] = "team";
})(LinkButtonIconType || (LinkButtonIconType = {}));
/**
...
const iconSwitch = (icon) => {
    switch (icon) {
        case LinkButtonIconType.LOCATION:
            return (<MapPinIcon aria-label={`location`} className={clsx(`h-[1.125rem] w-[1.125rem]`, `3xl:h-6 3xl:w-6`)}/>);
        case LinkButtonIconType.SERVICES:
            return (<WrenchScrewdriverIcon aria-label={`services`} className={clsx(`h-[1.125rem] w-[1.125rem]`, `3xl:h-6 3xl:w-6`)}/>);
        ...
        case LinkButtonIconType.TEAM:
            return (<UserGroupIcon aria-label={`team`} className={clsx(`h-[1.125rem] w-[1.125rem]`, `3xl:h-6 3xl:w-6`)}/>);
        default:
 ...
 */
export default function LinkButtonIcons(props) {
    const { icon } = props;
