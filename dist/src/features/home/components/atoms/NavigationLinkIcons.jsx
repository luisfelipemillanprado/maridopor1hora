 ...
 */
export var NavigationIcon;
(function (NavigationIcon) {
    NavigationIcon["ARROWUPRIGHT"] = "arrowupright";
    NavigationIcon["PLUS"] = "plus";
 ...
 */
export default function NavigationLinkIcons(props) {
    const { icon } = props;
    return (<span className={clsx(`horizontal bg-content2 h-[2.125rem] w-[2.1875rem] justify-center rounded-full`)}>
      {iconSwitch(icon)}
    </span>);
}
