...
export default function NavigationLink(props) {
    ...
    return (<div className={clsx(`horizontal h-auto w-auto`)}>
      <Button className={clsx(`bg-warning shadow-small pr-[0.1875rem]`)} endContent={<NavigationLinkIcons {...{ icon }}/>} as={Link} href={href} color={`warning`} variant={`shadow`} size={`md`} radius={`full`}>
