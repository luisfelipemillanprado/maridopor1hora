...
export default function CustomerTestimonials(props) {
    ...
    return (<Swiper navigation={true} effect={'cards'} grabCursor={true} modules={[EffectCards, Navigation]} className={clsx(`horizontal h-auto w-56 justify-center !pb-1.5`)}>
      {testimonials.map((item /*, index*/) => {
            return (<SwiperSlide key={item.key} className={clsx(`bg-content1 shadow-small w-full rounded-xl`)}>
