...
export default function Header(props) {
    ...
    return (<div className={clsx(`horizontal h-auto w-full`)}>
      <section aria-label={`peek-services`} className={clsx(`relative h-[28.125rem] w-full overflow-hidden rounded-tl-[1.25rem] rounded-tr-[1.25rem] rounded-br-[1.25rem]`, `rounded-bl-[1.25rem]`, `3xl:h-[34.1875rem] 2xl:h-[28.3125rem]`)}>
